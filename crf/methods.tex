...
Our calculations for the same is presented in \hyperref[crf_detailed]{Appendix A}. In essence, this constitutes a
...
Below we present the final fotm of the CCRF layer as used in geobind.
