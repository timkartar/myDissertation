...
current state of structural biology. In particular, analyzing protein-DNA co-crystals from PDB has
        ...
        which, although very noisy, still general enough to act as a proxy for energetics of the diverse 
        protein-DNA mechanisms that we see in co-crystal structures can serve as target to train our model. 
        Hence, our model (DeepPBS) takes as input a given co-crystal and
        learns to predict binding specificity of the co-crystal.
        ...
        pipelines and/or serving as guide for mechanistic hypoethization in general and there in
