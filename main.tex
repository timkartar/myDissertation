...
\usepackage{amsmath}
\let\oldAA\AA
\renewcommand{\AA}{\text{$\mathring{A}$}}
\usepackage{amssymb}
...
\usepackage[backend=biber, style=numeric, sortcites, maxnames=10, natbib=true, sorting=none]{biblatex}
...
\input{crf/abstract}
\input{crf/introduction}
\input{crf/methods}
\input{crf/results}
\input{crf/discussion}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\chapter{Proposal:  A generalized generative model for binding element design.}
%\input{design/abstract.tex}
%\input{design/introduction.tex}
%\input{design/proposed_method.tex}
%\input{design/discussion.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Geometric deep learning of protein–DNA binding specificity}
\input{pdna/abstract.tex}
\input{pdna/introduction.tex}
\input{pdna/results.tex}
\input{pdna/dataset.tex}
\input{pdna/methods.tex}
\input{pdna/discussion.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{RNAscape: Geometric mapping and customizable visualization of RNA structure}
\input{rnascape/abstract.tex}
\input{rnascape/introduction.tex}
\input{rnascape/methods.tex}
\input{rnascape/results.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{DNAproDB: an updated database for the automated and interactive analysis of protein–DNA complexes}
\input{dnaprodb/dnaprodb.tex}
%\input{rnascape/introduction.tex}
%\input{rnascape/methods.tex}
%\input{rnascape/results.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{RNAproDB: a webserver and interactive database for analyzing protein–RNA interactions}
\input{rnaprodb/rnaprodb.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RVAgene ############################################################
% Research Topic 1
\chapter{Tangential research: Generative modeling of gene expression time series data}
...
\red{Research described in this chapter was supervised by Dr. Adam MacLean as part of a rotation in his laboratory.}
%$^1$Quantitative and Computational Biology, University of Southern California
%\\

\end{flushleft}

\input{rvagene/abstract.tex}

\input{rvagene/introduction}
\input{rvagene/methods}

\section{Results}
\input{rvagene/simulation}
\input{rvagene/EScells}
\input{rvagene/comparison.tex}
\input{rvagene/jci}
\input{rvagene/comp_cost}
\input{rvagene/discussion}
